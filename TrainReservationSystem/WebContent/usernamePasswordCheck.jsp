...
<% try {
			...
			if(user.isEmpty() || pass.isEmpty() || confirm.isEmpty() || firstN.isEmpty() || lastN.isEmpty() || email.isEmpty()){
						%>
				...
				PreparedStatement checkUsername = con.prepareStatement("SELECT c.Username FROM customer c WHERE c.Username=?");
				...
				if(!userExists && pass.equals(confirm)){
					...
					String insert = "INSERT INTO TrainSystem.customer" + " VALUES " + "('" + user + "','" + firstN + "','" + lastN + "','" + pass + "','" + email + "')";
